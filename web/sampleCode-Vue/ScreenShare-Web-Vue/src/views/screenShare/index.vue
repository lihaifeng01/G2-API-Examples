...
export default {
  ...
  mounted() {
    ...
    this.client.on("stream-subscribed", (evt) => {
      ...
      const playOptions = {
        audio: evt.mediaType === "audio",
        video: evt.mediaType === "video",
        screen: evt.mediaType === "screen",
      };
      console.warn("开始播放对端的流", playOptions, div, evt.mediaType);
      remoteStream
        .play(div, playOptions)
        .then(() => {
          console.log("播放对端的流成功: ", playOptions, div, evt.mediaType);
